...
members = ['Elira Pendora', 'Pomu Rainpuff', 'Finana Ryugu', 'Selen Tatsuki', 'Rosemi Lovelock', 'Petra Gurin', 'Enna Alouette', 'Nina Kosaka', 'Reimu Endou', 'Millie Parfait', 'Ike Eveland', 'Mysta Rias', 'Vox Akuma', 'Luca Kaneshiro', 'Shu Yamino', 'Alban Knox', 'Yugo Asuma', 'Fulgur Ovid', 'Sonny Brisko', 'Uki Violeta', 'Kyo Kaneko', 'Maria Marionette', 'Aster Arcadia', 'Aia Amare', 'Ren Zotto', 'Scarle Yonaguni', 'Luxiem', 'NIJISANJI EN Official']
